...
% Image paths
cover_ source_path_BOSSBASE = 'H:\Master_Thesis\Databases\BossBase_1.01_cover\';
cover_source_path_RAISE = 'H:\Master_Thesis\Databases\Raise_dataset\cover_pgm\';
...
while(cnt <= 20)
    ...
    [stego, bit_count, bit_positions] = S_UNIWARD(cover_image, payload);
    ...
    while(disp_cnt <= 4)
        ...
        temp_row = horzcat(temp_row, "S-UNIWARD");
...
writematrix(write_rows, 'audit_log_Error_Rate_Detection_S_UNIWARD_point_4.xlsx');
