function [stego, bit_count, bit_positions] = HUGO_like(cover, payload, params)
...
[stego, bit_count, bit_positions] = EmbeddingSimulator(cover, rhoP1, rhoM1, round(numel(cover)*payload), true);
end
