...
% Image paths
cover_source_path_BOSSBASE = 'H:\Master_Thesis\Databases\BossBase_1.01_cover\';
...
while(cnt <= 20)
    ...
    [stego, bit_count, bit_positions] = HUGO_like(cover_image, payload, params);
    ...
    while(disp_cnt <= 1)
        ...
        temp_row = horzcat(temp_row, "HUGO");
...
writematrix(write_rows, 'audit_log_Error_Rate_Detection_HUGO_point_4.xlsx');
