function [lossy_cover_image, lossy_stego_image, lossy_flag] = PacketLoss_Image_Generation(p, r, sub_mat_rows, sub_mat_cols, total_packets, sub_matrix_size, blockImage_cover, blockImage_stego)
...
% Terminate this loop if it have run for 100 iterations. 
% Try for different combination
check_cnt = check_cnt + 1;
if(check_cnt > 500 && check >=10)
    lossy_flag = 0;
    break;
end
end
